...
#include "x64state.h"
#include "armstate.h"
#include "arm64state.h"
#include "registers_a32.h"
#include "registers_a64.h"

#include "ITraceReaderShared.h"

//
// We started the arm port with the v1 header, and while this header
// can not be used for arm, it did previously define two GUIDs which
// have since been renamed. We define aliases heres for the sake
// of not breaking any build.
//
// Note that we cant do "const GUID XXX = XXX_20;" since that causes
// a LNK4210 for some flavors of nirvana v1's ksmartcpu\kappwriter.obj
//

#define TRACE_FILE_SIGNATURE_A32 TRACE_FILE_SIGNATURE_A32_20
#define TRACE_FILE_SIGNATURE_KA32 TRACE_FILE_SIGNATURE_A32_20
...
#else
#define TR_MAX_INSTRUCTION_LEN      TR_MAX_INSTRUCTION_LEN_V1
#endif

union TR_REGISTER_STATE
{
   Nirvana::A32REGS A32State;
   Nirvana::A64REGS A64State;
